...
export const getFiatBalance = async (userId: number, currency: string): Promise<FiatBalance | null> => {
...
export const updateFiatBalance = async (userId: number, currency: string, amount: number) => {
